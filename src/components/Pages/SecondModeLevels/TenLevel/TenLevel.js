...
import backgroundImage from '../../../../assets/background_levels/SecondModeNine_Ten.png'; // Imagem de fundo do nível
import './TenLevel.css'; // Arquivo de estilos do nível
...
const TenLevel = () => {
    ...
    const MAX_HINTS = 5 + level - 1; // Número máximo de dicas permitidas
